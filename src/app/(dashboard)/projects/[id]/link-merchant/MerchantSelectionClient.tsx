...
export default function MerchantSelectionClient({ projectId, sourceId }: { projectId: string, sourceId: string }) {
    ...
    useEffect(() => {
        async function fetchAccounts() {
            try {
                const res = await fetch(`/api/projects/${projectId}/data-sources/${sourceId}/merchant-accounts`);
