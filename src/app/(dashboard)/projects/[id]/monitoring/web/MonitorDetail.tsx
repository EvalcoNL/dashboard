        ...
        <div>
            ...
            <div style={{ animation: "fadeIn 0.3s ease-out" }}>
                ...
                {tab === 'overview' && (<div style={{ paddingTop: "28px" }}>
                    ...
                    <Link href={`/projects/${domain.projectId}/monitoring/tracking`} style={{ textDecoration: "none" }}>
                        <div style={{
                        ...
                        <div>
                            ...
                            <div style={{ marginTop: "12px", padding: "12px", background: "rgba(99,102,241,0.05)", borderRadius: "8px", border: "1px solid rgba(99,102,241,0.1)" }}>
                                <p style={{ fontSize: "0.75rem", color: "var(--color-text-muted)", margin: 0, display: "flex", alignItems: "center", gap: "6px" }}>
                                    <Bell size={14} />
                                    Notificatie kanalen kunnen worden ingesteld via de <Link href={`/projects/${domain.projectId}/monitoring/incidents?tab=settings`} style={{ color: "var(--color-brand)", fontWeight: 600, textDecoration: "none" }} className="hover-underline">Incidenten instellingen</Link>.
                                </p>
                            </div>
                        </div>
                    </SettingsSection>
                        ...
                        {incidents.length === 0 ? (
                            ...
                            <div style={{ borderRadius: "10px", overflow: "hidden", border: "1px solid var(--color-border)" }}>
                                ...
                                {incidents.map((inc: any) => {
                                    ...
                                    return (
                                        <Link key={inc.id} href={`/projects/${domain.projectId}/monitoring/incidents/${inc.id}`} style={{ textDecoration: "none" }}>
                                            <div style={{
                                                display: "grid",
                                                gridTemplateColumns: "100px 1fr 180px 1fr 1fr 100px",
                                                padding: "12px 16px",
