...
function MonitorDetailPageContent({ projectId, clientName, domain }: MonitorDetailPageProps) {
    ...
    const handleDeleteMonitor = async () => {
        ...
        try {
            ...
            router.push(`/projects/${projectId}/monitoring/web`);
        } catch (e) {
            console.error(e);
    ...
    return (
        <div style={{ padding: "32px", maxWidth: "1200px", margin: "0 auto" }}>
            {/* ── Back link ─── */}
            <button
                onClick={() => router.push(`/projects/${projectId}/monitoring/web`)}
                style={{
