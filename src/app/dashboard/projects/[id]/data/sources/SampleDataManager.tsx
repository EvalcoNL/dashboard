...
export default function SampleDataManager({ clientId }: { clientId: string }) {
    ...
    const checkStatus = async () => {
        try {
            const res = await fetch(`/api/data-integration/sample?clientId=${clientId}`);
    ...
    const deleteData = async () => {
        ...
        try {
            const res = await fetch(`/api/data-integration/sample?clientId=${clientId}`, { method: "DELETE" });
            const data = await res.json();
            if (data.success) {
