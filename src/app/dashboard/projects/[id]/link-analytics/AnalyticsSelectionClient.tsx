...
export default function AnalyticsSelectionClient({ clientId, sourceId }: { clientId: string, sourceId: string }) {
    ...
    useEffect(() => {
        async function fetchAccounts() {
            try {
                ...
                const res = await fetch(`/api/projects/${clientId}/data-sources/${sourceId}/analytics-properties`);
